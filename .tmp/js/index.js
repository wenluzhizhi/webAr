...
var Main = function () {
  function Main() {
    ...
    this.isAndroid = /android/i.test(ua), this.isIphone = /(iPhone|iPad|iPod|iOS)/i.test(ua), this.isWeChat = /MicroMessenger/i.test(ua), this.iosversion = ua.match(/os\s+(\d+)/i) || false;
    this.winHeight = window.innerHeight;
    this.webAR = new _webar2.default();
  ...
  _createClass(Main, [{
    ...
    value: function preloader() {
      ...
      var introImg = '../img/' + this.oid + '.png';
      var video = '../resources/' + this.oid + '.mp4';
      ...
      this.preload.loadManifest([{ src: "../img/scan.gif" }, { src: "../img/light.gif" }, { src: "../img/button.gif" }, { src: "../img/mainbg.jpg" }, { src: "../img/button.png" },
    ...
    key: 'scan',
    value: function scan() {
      var top = $(".scan-boder").offset().top;
      var height = $(".scan-boder").height();
    ...
    value: function openCamera() {
      ...
      this.webAR.openCamera(this.video, this.deviceId).then(function (msg) {
        // 打开摄像头成功
        // 将视频铺满全屏(简单处理)
    ...
    value: function checkCamera() {
      ...
      this.webAR.listCamera().then(function (videoDevice) {
